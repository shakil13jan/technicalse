...
if (document.querySelector('.footer-copyright')) {
  ...
  document.querySelector('.footer-copyright').innerHTML = 'Copyright &#169; ' + year + ' <a href="./">Marufcityoil</a>, All Rights Reserved';
}
...
const responseArr = [
...

    {
        ...
        faq2: "Why is Technial Service Expert Company perfect for your design?",
...

    {
        ...
        answer2:
            "Technial Service Expert Company is the perfect partner who can build your home interiors just the way you want! Our design experts customize designs as per your needs. They will listen to your ideas and suggest options. At Aiskcon, we incorporate advanced technology into our modular solutions to create flawless interiors and also to expedite the process of making your dream home a reality.",
        answer3:
